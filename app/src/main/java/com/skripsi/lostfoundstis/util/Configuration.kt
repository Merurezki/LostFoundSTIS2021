...
class Configuration {
    ...
    val URL_MAIN         = "http://192.168.100.54/LostFound/"
    val URL_USER_LOGIN   = "http://192.168.100.54/LostFound/Login.php"

    val URL_GET_ALL_CARI = "http://192.168.100.54/LostFound/TampilSemuaPencarian.php"
    val URL_GET_ONE_CARI = "http://192.168.100.54/LostFound/DetailPencarian.php?id_cari="
    val URL_ADD_CARI     = "http://192.168.100.54/LostFound/TambahPencarian.php"
    val URL_UPLOAD_CARI  = "http://192.168.100.54/LostFound/UploadFotoPencarian.php"
    val URL_UPDATE_CARI  = "http://192.168.100.54/LostFound/UpdatePencarian.php"
    val URL_UPDATE_FOTO  = "http://192.168.100.54/LostFound/UpdateFotoPencarian.php"
    val URL_DELETE_CARI  = "http://192.168.100.54/LostFound/HapusPencarian.php?id_cari="
    val URL_FINISH_CARI  = "http://192.168.100.54/LostFound/SelesaiPencarian.php?id_cari="

    val URL_GET_ALL_TEMU = "http://192.168.100.54/LostFound/TampilSemuaPenemuan.php"
    val URL_GET_ONE_TEMU = "http://192.168.100.54/LostFound/DetailPenemuan.php?id_temu="

    val URL_IMG_LOC      = "http://192.168.100.54/LostFound/img/"
    val URL_IMG_LOC_CARI = "http://192.168.100.54/LostFound/img/foto_cari/"
    val URL_IMG_LOC_TEMU = "http://192.168.100.54/LostFound/img/foto_temu/"

    val URL_GET_ALL_SAYA = "http://192.168.100.54/LostFound/MyPencarian.php?id_pencari="

    val URL_GET_PROFIL   = "http://192.168.100.54/LostFound/MyProfil.php?id_user="
    val URL_UPDATE_TLP   = "http://192.168.100.54/LostFound/UpdateTelepon.php?id_user="
    ...
    val URL_GET_JBAR     = "http://192.168.100.54/LostFound/DaftarJenisBarang.php"
    val TAG_JBAR_JSON    = "result_jbar"
    val TAG_ID_JBAR      = "id_jbar"
    val TAG_KEL_BAR      = "kel_bar"
    val TAG_KAT_BAR      = "kat_bar"

    val URL_GET_LOK      = "http://192.168.100.54/LostFound/DaftarLokasiKampus.php"
